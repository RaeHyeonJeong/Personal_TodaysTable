													...
													if (idx <= 2) {
														...
														$("div#storelist")
																.append(
																		...
																		'<div class="storeInfo" id="storeInfo">'
																				+ '<div class="col-sm-6 col-lg-4 mb-5 hover-animate" data-marker-id="59c0c8e33b1527bfe2abaf92" style="margin-left:10%; width:900px;">'
																				+ '<p style="display:none;">'
																				+ url
																				+ '</p> <div class="card h-100 border-0 shadow">'
																				...
																				+ '</div>'
																				+ '<div class="card-body">'
																				+ '<p class="text-sm text-muted fw-bold mb-3">카테고리 :'
																				+ data[idx].category
																				+ '</p>'
																				+ '<p class="text-sm text-muted fw-bold mb-3">주소 :'
																				+ data[idx].address
																				+ '</p>'
																				+ '<p class="text-sm text-muted fw-bold mb-3">전화번호 :'
																				+ data[idx].tel
																				+ '</p>'
																				...
																				+ '<button class="btn btn-primary btn-sm" type="submit">찜하기'
																				+ '</button>'
														...
														window.onscroll = function(e) {
															...
															if ((window.innerHeight + window.scrollY) >= document.body.offsetHeight) {
																...
																if (count >= 3 && count < data.length)
																	count++; //count를 받아온 정보길이 개수만큼 자동증가
																...
																var addContent = '<div class="storeInfo" id="storeInfo">'
																		+ '<div class="col-sm-6 col-lg-4 mb-5 hover-animate" data-marker-id="59c0c8e33b1527bfe2abaf92" style="margin-left:10%;width:900px;">'
																		+ '<p style="display:none;">'
																		+ url
																		+ '</p> <div class="card h-100 border-0 shadow">'
								...
								window.onscroll = function(e) {
									...
									if ((window.innerHeight + window.scrollY) >= document.body.offsetHeight) {
										...
										var addContent = '<div class="storeInfo" id="storeInfo">'
												...
												+ '<div class="card-img-overlay-bottom z-index-20">'
												+ '<h4 class="text-white text-shadow">'
												+ data[storeArray[0]].name
												+ '</h4>'
												+ '</div>'
												+ '</div>'
												+ '<div class="card-body">'
												+ '<p class="text-sm text-muted fw-bold mb-3">카테고리 :'
												+ data[storeArray[0]].category
												+ '</p>'
												+ '<p class="text-sm text-muted fw-bold mb-3">주소 :'
												+ data[storeArray[0]].address
												+ '</p>'
												+ '<p class="text-sm text-muted fw-bold mb-3">전화번호 :'
												+ data[storeArray[0]].tel
												+ '</p>'
												+ '<div class="d-flex justify-content-between align-items-center">'
												+ '<p class="mb-2 text-sm fw-bold">'
												+ '<i class="fa fa-star text-warning"></i><i class="fa fa-star text-warning"></i><i class="fa fa-star text-warning"></i><i class="fa fa-star text-warning"></i>'
