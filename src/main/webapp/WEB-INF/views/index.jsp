			...
			<form action="searchResult.do">
				<div class="row">
					<div class="col-lg-5 d-flex align-items-center form-group">
						<input class="form-control border-0 shadow-0" type="text" name="search" placeholder="가게명, 음식점을 검색해보세요">
					</div>
					<div class="col-md-6 col-lg-3 d-flex align-items-center form-group">
						<div class="input-label-absolute input-label-absolute-right w-100">
							<label class="label-absolute" for="location"><i class="fa fa-crosshairs"></i> </label> <input class="form-control border-0 shadow-0" type="text" name="location" placeholder="위치 검색" id="location">
						</div>
					</div>
					...
					<div class="col-sm-6 col-lg-4 mb-5 hover-animate" data-marker-id="59c0c8e33b1527bfe2abaf92">
						<div class="card h-100 border-0 shadow">
							...
							<div class="card-body">
								...
								<button class="btn btn-primary h-100" type="button" onclick="closePopup()" style="width: 100px; margin: auto; display: block;">닫기</button>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="container-fluid">
			...
			<div class="swiper-container swiper-container-mx-negative items-slider-full px-lg-5 pt-3">
				...
				<div class="swiper-wrapper pb-5">
					...
					<div class="swiper-slide h-auto px-2">
						<!-- venue item-->
						<div class="w-100 h-100 hover-animate" data-marker-id="59c0c8e3a31e62979bf147c9" style="width: 400; height: 200;">
							<div class="card h-100 border-0 shadow">
			...
			<div class="text-center mt-5">
				<button class="btn btn-outline-primary" id="recBTN" type="button" onclick="showPopup(true)">오늘의 식탁은 ?</button>
			</div>
		</div>
	</section>
	<!-- Footer-->
									...
									if (data.length == 0) {
										...
										$(data).each(
												function(idx) {
													...
													$("tbody").append(
															'<tr><td>카테고리 :</td><td>' + data[idx].category + '</td></tr>' + '<tr><td>주소 :</td><td>'
																	+ data[idx].address + '</td></tr>' + '<tr><td>전화번호 :</td><td>' + data[idx].tel
																	+ '</td></tr>'
