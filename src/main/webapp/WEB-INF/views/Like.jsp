							...
							<div class="d-flex flex-column d-block d-sm-flex review">
								<div class="d-flex bd-highlight mb-3">
									<div class="p-2 bd-highlight">
										<img class="d-block avatar avatar-xl " src="resources/img/avatar/avatar-4.jpg" alt="">
										<%-- <span
									...
									<div class="ms-auto p-2 bd-highlight">
										<input type="checkbox" class="checkbox" id="checkbox${cnt.count}" name="checkbox${cnt.count}" /> <label for="checkbox${cnt.count}"> <svg id="heart-svg" viewBox="-80 -40 58 57" xmlns="http://www.w3.org/2000/svg">
